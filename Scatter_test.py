...
###New seasonal ranks model using full pres cycle rather than ranks for every year
url_base = 'https://raw.githubusercontent.com/mslade50/Multi_page/main/'
model_df = pd.read_excel(url_base + 'MDM.personaltweaks_2.xlsx')
fwd_df = pd.read_excel(url_base + 'MDM.personaltweaks_2.xlsx', sheet_name='Python Fwds')
df = pd.read_csv(url_base + 'MDM.personaltweaks_python_2.csv')
